...
!(function (t) {
  ...
  function t(t, e) {
    return (
      (e = e || x),
      H.test(t) ? e.getElementsByClassName(t.slice(1)) : W.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t)
    );
  }
  function e(t) {
    if (!O) {
  ...
  function a(t, e) {
    var i =
      t && (t.matches || t.webkitMatchesSelector || t.mozMatchesSelector || t.msMatchesSelector || t.oMatchesSelector);
    return !!i && i.call(t, e);
  }
  function r(t) {
    return A(t)
...
!(function (t) {
  ...
  function n(e) {
    return H.arr(e)
      ? e
      : (H.str(e) && (e = t(e) || e), e instanceof NodeList || e instanceof HTMLCollection ? [].slice.call(e) : [e]);
  }
  function s(t, e) {
  ...
  function h(t) {
    function e(t, e, i) {
      return (
        0 > i && (i += 1),
        1 < i && --i,
        i < 1 / 6 ? t + 6 * (e - t) * i : 0.5 > i ? e : i < 2 / 3 ? t + (e - t) * (2 / 3 - i) * 6 : t
      );
    }
    s =
  ...
  function w(t, e) {
    ...
    return (
      (i += ""),
      { original: i, numbers: i.match(n) ? i.match(n).map(Number) : [0], strings: H.str(t) || e ? i.split(n) : [] }
    );
  }
  function C(t) {
    return (
  ...
  function M(t, e) {
    ...
    return n(t)
      .map(function (t, i) {
        return (
          (i = i ? 0 : e.delay), (t = H.obj(t) && !H.pth(t) ? t : { value: t }), H.und(t.delay) && (t.delay = i), t
        );
      })
      .map(function (t) {
        return r(t, i);
  ...
  function D(t) {
    ...
    function r(t) {
      ...
      (g >= p || !e) && (v.began || ((v.began = !0), o("begin")), o("run")),
        g > r && g < e
          ? s(g)
          : (g <= r && 0 !== f && (s(0), m && a()), ((g >= e && f !== e) || !e) && (s(e), m || a())),
        o("update"),
        t >= e &&
          (v.remaining
            ? ((h = l), "alternate" === v.direction && (v.reversed = !v.reversed))
            : (v.pause(), v.completed || ((v.completed = !0), o("complete"), "Promise" in window && (u(), (c = i())))),
          (d = 0));
    }
    t = void 0 === t ? {} : t;
    var l,
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (n.length) {
                    ...
                    e.remove(s[0]),
                      s.css({ display: "block", overflow: "hidden", height: 0, paddingTop: "", paddingBottom: "" });
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  var i = this,
                    n = t(e.target);
                  this.options.closeOnClick && n.closest(".dropdown-content").length && !this.isTouchMoving
                    ? setTimeout(function () {
                        i.close();
                      }, 0)
                    : (!n.closest(".dropdown-trigger").length && n.closest(".dropdown-content").length) ||
                      setTimeout(function () {
                        i.close();
                      }, 0),
              ...
              },
              {
                ...
                value: function () {
                  var t = this.$el.height() > 0 ? this.el.parentNode.offsetHeight : 500,
                    ...
                    a = e * ((s + o - n) / (t + o));
                  this._enabled
                    ? i > s && n < s + o && (this.$img[0].style.transform = "translate3D(-50%, " + a + "px, 0)")
                    : (this.$img[0].style.transform = "");
                },
              },
            ],
          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  this.isOpen &&
                    ((this.isHovered = !1), (this.isFocused = !1), (this.isOpen = !1), this._setExitDelayTimeout());
                },
              },
              {
                ...
                value: function () {
                  ...
                  (this.xMovement = 0),
                    ...
                    "top" === this.options.position
                      ? ((h += -o - l), (d += s / 2 - a / 2), (this.yMovement = -this.options.transitionMovement))
                      : "right" === this.options.position
                      ? ((h += n / 2 - o / 2), (d += s + l), (this.xMovement = this.options.transitionMovement))
                      : "left" === this.options.position
                      ? ((h += n / 2 - o / 2), (d += -a - l), (this.xMovement = -this.options.transitionMovement))
  ...
  (function (t) {
    ...
    function a(e) {
      ...
      null !== i &&
        (h.show(e, i),
        "ontouchstart" in t &&
          (i.addEventListener("touchend", h.hide, !1), i.addEventListener("touchcancel", h.hide, !1)),
          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  var i = 0;
                  this.isDragged ? (i = this.percentOpen) : t(this._overlay).css({ display: "block" }),
                    e.remove(this._overlay),
                    e({
                ...
                value: function () {
                  (s._visibleElements = s._visibleElements.filter(function (t) {
                    ...
                    s._visibleElements[0]
                      ? (t(this.options.getActiveElement(s._visibleElements[0].attr("id"))).removeClass(
                          this.options.activeClass
                        ),
                        s._visibleElements[0][0].M_ScrollSpy && this.id < s._visibleElements[0][0].M_ScrollSpy.id
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  13 !== t.keyCode &&
                    38 !== t.keyCode &&
                    40 !== t.keyCode &&
                    (this.oldVal !== e && M.tabPressed && this.open(), (this.oldVal = e));
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  i === M.keys.ENTER && this.activeIndex >= 0
                    ? (s = t(this.container).children("li").eq(this.activeIndex)).length &&
                    ...
                    : (i !== M.keys.ARROW_UP && i !== M.keys.ARROW_DOWN) ||
                      ...
                      i === M.keys.ARROW_DOWN && this.activeIndex < o - 1 && this.activeIndex++,
                      this.$active.removeClass("active"),
                      this.activeIndex >= 0 &&
                        ((this.$active = t(this.container).children("li").eq(this.activeIndex)),
                ...
                value: function (e, i) {
                  ...
                  for (var r = 0; r < s.length; r++) {
                    var l = s[r],
                      h = t("<li></li>");
                    l.data
                      ? h.append('<img src="' + l.data + '" class="right circle"><span>' + l.key + "</span>")
        ...
        if ((e instanceof Element && (e = t(e)), e.length)) {
          ...
          i.html(d),
            ...
            e.data("original-height") <= i.innerHeight()
              ...
              : e[0].value.length < e.data("previous-length") && e.css("height", e.data("original-height") + "px"),
      ...
      t(document).ready(function () {
        ...
        t(".materialize-textarea").each(function () {
          ...
          t(document).on("change", '.file-field input[type="file"]', function () {
            for (
              var e = t(this).closest(".file-field").find("input.file-path"), i = t(this)[0].files, n = [], s = 0;
              s < i.length;
              s++
            )
              n.push(i[s].name);
        ...
        function s(i, n) {
          ...
          return (
            ...
            o.$slides.find("img").each(function (e) {
              ...
              t(e).attr("src") !== i &&
                (t(e).css("background-image", 'url("' + t(e).attr("src") + '")'), t(e).attr("src", i));
            }),
            o._setupIndicators(),
            o.$active
              ? o.$active.css("display", "block")
              : (o.$slides.first().addClass("active"),
                e({ targets: o.$slides.first()[0], opacity: 1, duration: o.options.duration, easing: "easeOutQuad" }),
                (o.activeIndex = 0),
            ...
            [
              ...
              },
              {
                ...
                value: function (t) {
                  var i = this;
                  if (
                    (t >= this.$slides.length ? (t = 0) : t < 0 && (t = this.$slides.length - 1), this.activeIndex != t)
                  ) {
  ...
  (function (t, e) {
    t(document).on("click", ".card", function (i) {
      if (t(this).children(".card-reveal").length) {
        ...
        t(i.target).is(t(".card-reveal .card-title")) || t(i.target).is(t(".card-reveal .card-title i"))
          ? e({
              targets: s[0],
              translateY: 0,
              duration: 225,
              ...
              },
              {
                ...
                value: function () {
                  (this.$input = this.$el.find("input")),
                    this.$input.length || ((this.$input = t("<input></input>")), this.$el.append(this.$input)),
              ...
              },
              {
                ...
                value: function () {
                  this.options.showClearBtn &&
                    (t(this.clearBtn).css({ visibility: "" }), (this.clearBtn.innerHTML = this.options.i18n.clear)),
              ...
              },
              {
                ...
                value: function (t) {
                  return (
                    ...
                    t.month > 11 && ((t.year += Math.floor(Math.abs(t.month) / 12)), (t.month -= 12)),
                    t
                  );
                },
              },
                ...
                value: function (t, e, i) {
                  ...
                  for (var g = !1, _ = 0, y = 0; _ < f; _++) {
                    ...
                    h.push(this.renderDay(D)),
                      7 == ++y && (l.push(this.renderRow(h, s.isRTL, g)), (h = []), (y = 0), (g = !1));
                  }
                  ...
                  for (h = [], r = 0; r < 12; r++)
                    h.push(
                      '<option value="' +
                        ...
                        ((u && r < d.minMonth) || (c && r > d.maxMonth) ? 'disabled="disabled"' : "") +
                        ">" +
                        d.i18n.months[r] +
                        "</option>"
                    );
                  for (
                    v = '<select class="datepicker-select orig-select-month" tabindex="-1">' + h.join("") + "</select>",
                    ...
                    r >= d.minYear &&
                      h.push(
                        '<option value="' + r + '" ' + (r === n ? 'selected="selected"' : "") + ">" + r + "</option>"
                      );
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    (this.options.twelveHour &&
                      void 0 !== t[1] &&
                      (t[1].toUpperCase().indexOf("AM") > 0 ? (this.amOrPm = "AM") : (this.amOrPm = "PM"),
                ...
                value: function () {
                  ...
                  this.amplitude &&
                    ...
                    (e = this.amplitude * Math.exp(-t / this.options.duration)) > 2 || e < -2
                      ? (this._scroll(this.target - e), requestAnimationFrame(this._autoScrollBound))
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    m.index() !== f &&
                      ...
                      this.$indicators.find(".indicator-item").eq(f)[0].classList.add("active"));
                  }
                  if (!this.noWrap || (this.center >= 0 && this.center < this.count)) {
                    (l = this.images[this._wrap(this.center)]),
                      t(l).hasClass("active") ||
                        (this.$el.find(".carousel-item").removeClass("active"), l.classList.add("active"));
                    var g =
                      h +
                      " translateX(" +
                      -o / 2 +
                  ...
                  for (n = 1; n <= s; ++n) {
                    if (
                      (this.options.fullWidth
                        ...
                        : ((d = this.options.dist * (2 * n + r * a)), (u = 1 - v * (2 * n + r * a))),
                  ...
                  p !== this.center &&
                    ...
                    "function" == typeof this.oneTimeCallback &&
                      (this.oneTimeCallback.call(this, b[0], this.dragged), (this.oneTimeCallback = null));
                },
              },
              {
                      ...
                      this.$selectOptions.each(function (i) {
                        if (t(i).is("option")) {
                          ...
                          t(e.dropdownOptions).append(
                            t('<li class="optgroup"><span>' + i.getAttribute("label") + "</span></li>")[0]
                          ),
                            s.each(function (t) {
              ...
              },
              {
                ...
                value: function (e, i, n) {
                  var s = i.disabled ? "disabled " : "",
                    ...
                    a = this.isMultiple
                      ? '<label><input type="checkbox"' + s + '"/><span>' + i.innerHTML + "</span></label>"
                      : i.innerHTML,
                    r = t("<li></li>"),
                    l = t("<span></span>");
                ...
                value: function () {
                  ...
                  for (var e in this._valueDict) {
                    ...
                    t(i.optionEl).find('input[type="checkbox"]').prop("checked", n),
                      n
                        ? (this._activateOption(t(this.dropdownOptions), t(i.optionEl)), (this._keysSelected[e] = !0))
